...
Pour facilité la mise en place des dépendance, jeedom vas gérer seul l’installation et la compilation du logiciel openCv.
...
image::../images/openCv_screenshot_configuration.jpg[]
...
* Personnalisé les paramettre par defaut de openCv

*  state_id_img_size_percent
*  ocr_img_size_percent
*  Calibrage de votre camera améliore la précision de la détection dans les cas où des plaques d'immatriculation sont capturés à un angle raide (Utilisez l'utilitaire openCv-utils-calibration pour calibrer votre camera fixe pour ajuster un angle )
...
*  openCv peut balayer la même image plusieurs fois avec randomisation différent. Mettre ce paramètre à une valeur plus grande que 1 peut augmenter la précision, mais augmentera le temps de traitement linéaire
*  openCv détecte les cultures de plaque à contraste élevé et utilise une technique de détection de bord alternatif. Mettre cette option à 0.0 classerait toutes les images comme contraste élevé, la mise à 1.0 classerait pas d'images comme contraste élevé.
...
Nous pouvons voir le status de configuration et d’activation d’openCv dans le cadre "Démon"
