$('.snapshot').on('click', function() {
    $('#md_modal').dialog({
		...
		height: 600,
		width: 850});
    $('#md_modal').load('index.php?v=d&modal=openCv.history&plugin=openCv&type=openCv').dialog('open');
});
$('.logAlprd').on('click', function() {
    $('#md_modal').dialog({
		...
		height: 600,
		width: 850});
    $('#md_modal').load('index.php?v=d&modal=openCv.logAlprd&plugin=openCv&type=openCv').dialog('open');
});
...
$('#table_cmd tbody').on( 'click','.bt_movePlate', function() {
    ...
    $('#md_modal').load('index.php?v=d&modal=movePlate.openCv&plugin=openCv&type=openCv&id='+id).dialog('open');	
});
