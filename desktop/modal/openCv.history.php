...
$SnapshotFolder = config::byKey('SnapshotFolder','openCv');
...
<script>
    ...
    $('.displayImage').on('click', function() {
        ...
        $('#md_modal2').load('index.php?v=d&plugin=openCv&modal=openCv.displayImage&src='+ $(this).attr('src')).dialog('open');
    });
	...
	function RemoveFile(filename){	
        $.ajax({// fonction permettant de faire de l'ajax
            ...
            url: "plugins/openCv/core/ajax/openCv.ajax.php", // url du fichier php
            data: {
                action: "removeRecord",
                file: filename,
            },
